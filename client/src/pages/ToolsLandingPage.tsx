...
const imageTools: Tool[] = [
  ...
  { name: "Compress Image Size", description: "Reduce image file size", category: "Image Tools", icon: "🗜️", comingSoon: true },
  { name: "Resize Image Dimensions", description: "Change image width and height", category: "Image Tools", icon: "📐", comingSoon: true },
  ...
  { name: "Crop Image", description: "Trim and crop images", category: "Image Tools", icon: "✂️", comingSoon: true },
  ...
  { name: "Add Text to Image", description: "Add text overlays to images", category: "Image Tools", icon: "📝", comingSoon: true },
  ...
  { name: "Flip Image", description: "Flip images horizontally or vertically", category: "Image Tools", icon: "🔁", comingSoon: true },
  ...
  { name: "Make Round Image", description: "Create circular images", category: "Image Tools", icon: "⭕", comingSoon: true },
  { name: "Add Border to Image", description: "Add frames and borders", category: "Image Tools", icon: "🖼️", comingSoon: true },

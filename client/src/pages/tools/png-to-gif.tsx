...
export default function PNGtoGIF() {
    ...
    const [targetFormat, setTargetFormat] = useState<SupportedImageFormat>("image/gif");
    ...
    const handleDownload = () => {
        ...
        const targetExt = formatOptions.find(f => f.value === targetFormat)?.extension || 'gif';
    ...
    const quickConversions = [
        { from: "Any", to: "image/gif", label: "To GIF" },
    ...
    return (
        <ToolLayout
            ...
            description="Convert PNG to GIF, JPG, PDF, and more instantly. Fast, free, and secure online conversion."
            category="Image Tools"
            keywords={["png to gif", "gif converter", "image converter", "pdf converter"]}
            howToSteps={[
                { name: "Upload File", text: "Upload your PNG file" },
                { name: "Select Target", text: "Choose GIF or other output format" },

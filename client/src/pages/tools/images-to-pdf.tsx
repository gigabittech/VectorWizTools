...
export default function ImagesToPDF() {
  ...
  return (
    <ToolLayout
      title="IMAGES to PDF"
      description="Convert from JPG online. Combine multiple images into a single PDF document."
      category="PDF Tools"
      keywords={["images to pdf", "jpg to pdf", "convert images", "image converter", "photos to pdf"]}
      howToSteps={[
        { name: "Upload Images", text: "Upload one or more image files" },

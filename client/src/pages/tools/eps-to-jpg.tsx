...
export default function EPStoJPG() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "This file format might require specialized processing. Try a simpler file.",
                variant: "destructive",
            });
        }
    };
    ...
    return (
        <ToolLayout
            ...
            description="Convert your EPS vector files to high-quality JPG images or other formats instantly. Fast, free, and secure online conversion."
            category="Image Tools"
            keywords={["eps to jpg", "eps to png", "eps converter", "vector to image"]}
            howToSteps={[
                { name: "Upload EPS", text: "Upload your EPS file (postscript vector format)" },
                { name: "Select Format", text: "Choose JPG or any other target format" },
                { name: "Download", text: "Save your converted file" },
            ]}
        >
            <div className="space-y-6">
                ...
                {status !== "idle" && (
                    <ProcessingIndicator
                        ...
                        errorMessage="Failed to convert. Some formats may not be supported in-browser."
                    />
                )}

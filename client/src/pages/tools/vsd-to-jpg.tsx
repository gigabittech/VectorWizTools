...
export default function VSDtoJPG() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "Visio files are complex for browsers. Some features might not be supported.",
                variant: "destructive",
            });
        }
    };
    ...
    return (
        <ToolLayout
            ...
            description="Convert your Microsoft Visio diagrams to JPG or any other format instantly. Easy and fast online Visio conversion."
            category="Image Tools"
            keywords={["vsd to jpg", "vsdx to jpg", "convert visio to image", "visio converter"]}
            howToSteps={[
                { name: "Upload File", text: "Upload your VSD/VSDX or any other image file" },
                { name: "Select Format", text: "Choose JPG or your desired target format" },
                { name: "Download", text: "Save your converted diagram instantly" },
            ]}
        >
            <div className="space-y-6">
                <div className="backdrop-blur-md bg-white/70 border border-white/40 rounded-xl p-6 hover:bg-white/80 transition-all">
                    <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
                        <FileEdit className="h-5 w-5 text-[#0B9F47]" />
                        Upload File
                    </h2>
                    <FileUploader

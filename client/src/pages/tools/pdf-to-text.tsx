...
export default function PDFToText() {
  ...
  return (
    <ToolLayout
      title="PDF to Text"
      description="Convert a PDF to Text. Extract all text content from PDF documents for editing and analysis."
      category="PDF Tools"
      keywords={["pdf to text", "extract text", "pdf text", "convert pdf", "pdf extractor"]}
      howToSteps={[

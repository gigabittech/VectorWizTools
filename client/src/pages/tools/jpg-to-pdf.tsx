...
export default function JPGToPDF() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: "Images converted to PDF",
      });
    } catch (error) {
      setStatus("error");
      toast({
  ...
  return (
    <ToolLayout
      title="JPG to PDF"
      description="Convert JPG images and receive as a PDF. Combine multiple images into a single PDF document."
      category="PDF Tools"
      keywords={["jpg to pdf", "image to pdf", "convert jpg", "jpg converter", "images to pdf"]}
      howToSteps={[
        { name: "Upload Images", text: "Upload one or more JPG images" },

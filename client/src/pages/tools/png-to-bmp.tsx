...
export default function PNGtoBMP() {
    const [files, setFiles] = useState<UploadedFile[]>([]);
    const [status, setStatus] = useState<ProcessingStatus>("idle");
    const [targetFormat, setTargetFormat] = useState<SupportedImageFormat>("image/bmp");
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "An error occurred during conversion. Please try another file.",
                variant: "destructive",
            });
        }
    };
    ...
    const handleDownload = () => {
        ...
        const targetExt = formatOptions.find(f => f.value === targetFormat)?.extension || 'bmp';
    ...
    return (
        <ToolLayout
            ...
            description="Convert your PNG images to BMP or any other format instantly. Fast, free, and secure online conversion while preserving image details."
            category="Image Tools"
            keywords={["png to bmp", "convert png to bitmap", "bmp converter", "image format converter"]}
            howToSteps={[
                { name: "Upload File", text: "Upload your PNG or any other image file" },
                { name: "Select Format", text: "Choose BMP or your desired target format" },
        ...
        >
            <div className="space-y-6">
                ...
                {status !== "idle" && (
                    <ProcessingIndicator status={status} message="Processing file..." successMessage="Conversion complete!" errorMessage="Failed to convert." />
                )}

  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          <div className="absolute -inset-1 bg-gradient-to-r from-[#0B9F47] via-[#0B9F47] to-[#0B9F47] rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
          <div className="relative backdrop-blur-xl bg-white/80 border border-white/50 rounded-2xl p-8 shadow-2xl">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2.5 bg-gradient-to-tr from-[#0B9F47] to-[#0B9F47] rounded-xl shadow-lg shadow-emerald-100">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Button
                ...
                className="h-14 px-10 bg-[#0B9F47] hover:bg-[#0B9F47] text-white text-lg font-bold rounded-xl shadow-xl shadow-emerald-100 transition-all duration-300 disabled:opacity-70 flex items-center gap-2"
              >
                {status === "processing" ? (
                  <>
            ...
            >
                      ...
                      >
                        ...
                        <div className="p-4 bg-white">
                          <Button
                            ...
                            className="w-full h-11 bg-[#0B9F47] hover:bg-[#0B9F47] text-white flex items-center justify-center gap-2 rounded-xl font-bold text-sm shadow-md transition-all active:scale-95"
                          >
                ...
                <div className="w-full lg:w-72 order-1 lg:order-2">
                  ...
                  >
                    <div className="flex flex-col items-center text-center space-y-4">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-[#0B9F47] via-[#0B9F47] to-[#0B9F47] p-1">
                      ...
                      <div className="py-4">
                        <span className="text-4xl font-black text-[#0B9F47]">{images.length}</span>
                      </div>
                      ...
                      <div className="w-full pt-4">
                        <Button
                          ...
                          className="w-full border-[#0B9F47] text-[#0B9F47] hover:bg-[#0B9F47] hover:text-white font-bold rounded-xl"
                        >
                          Download All
                        </Button>
                      </div>
              ...
              {status === "processing" && (
                <div className="flex flex-col items-center justify-center p-12 space-y-4">
                  <Loader2 className="h-10 w-10 text-[#0B9F47] animate-spin" />
          ...
          >
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center text-[#0B9F47] mb-4">
                  {tip.icon}
                </div>

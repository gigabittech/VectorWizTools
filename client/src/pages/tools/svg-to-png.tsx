...
export default function SVGtoPNG() {
    ...
    return (
        <ToolLayout
            ...
            description="Convert SVG vector files to PNG, JPG, PDF, and more instantly. High resolution conversion."
            category="Image Tools"
            keywords={["svg to png", "svg converter", "vector to raster", "image converter"]}
            howToSteps={[
                { name: "Upload File", text: "Upload your SVG file" },

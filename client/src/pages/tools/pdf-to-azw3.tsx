...
export default function PDFToAZW3() {
  ...
  const handleFilesSelected = (uploadedFiles: UploadedFile[]) => {
    ...
    toast({
      ...
      description: "PDF to AZW3 conversion requires server-side processing. This feature is coming soon.",
      variant: "default",
    });
  };
  ...
  return (
    <ToolLayout
      ...
      howToSteps={[
        ...
        { name: "Convert", text: "Click Convert to AZW3" },
        { name: "Download", text: "Download your AZW3 file" },
      ]}
    >
        ...
        <div className="backdrop-blur-md bg-white/70 border border-white/40 rounded-xl p-6">
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-900">
              <strong>Note:</strong> PDF to AZW3 conversion requires server-side processing. This feature is coming soon.
            </p>
          </div>
        </div>
      </div>

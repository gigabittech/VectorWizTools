      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Turnaround Estimator</h1>
              <p className="text-muted-foreground">Get delivery estimates based on service type and complexity</p>
            </div>
          </div>
        </div>
        ...
        <Card className="mt-8">
          <CardHeader>
            <CardTitle>Service Timeline Reference</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {services.map((service) => (
                <div key={service.value} className="p-4 bg-muted/30 rounded-lg">
                  <h3 className="font-semibold mb-1">{service.label}</h3>
                  <Badge variant="secondary">{service.baseTime}</Badge>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              <h3 className="font-semibold text-blue-700 mb-2">Express Service Available</h3>

...
export default function WEBPtoJPG() {
    ...
    return (
        <ToolLayout
            ...
            description="Convert WEBP to JPG, PNG, PDF, and more instantly. Fast, free, and secure online conversion."
            category="Image Tools"
            keywords={["webp to jpg", "webp converter", "image converter", "pdf converter"]}
            howToSteps={[
                { name: "Upload File", text: "Upload your WEBP or other image file" },

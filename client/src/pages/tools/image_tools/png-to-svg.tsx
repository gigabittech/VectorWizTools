...
export default function PNGtoSVG() {
    ...
    return (
        <ToolLayout
            ...
            description="Convert PNG to SVG, PNG, PDF, and more instantly. Fast, free, and secure online conversion."
            category="Image Tools"
            keywords={["png to svg", "png converter", "image converter", "pdf converter"]}
            howToSteps={[

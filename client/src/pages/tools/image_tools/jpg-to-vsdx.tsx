...
export default function JPGtoVSDX() {
    const [files, setFiles] = useState<UploadedFile[]>([]);
    const [status, setStatus] = useState<ProcessingStatus>("idle");
    const [targetFormat, setTargetFormat] = useState<SupportedImageFormat>("application/vnd.visio");
    ...
    const formatOptions: { value: SupportedImageFormat; label: string; extension: string }[] = [
        { value: "application/vnd.visio", label: "VSDX (Visio)", extension: "vsdx" },
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            if (targetFormat === "application/vnd.visio") {
                ...
                const response = await fetch(prefixUrl("/api/tools/jpg-to-vsdx"), {
                    method: "POST",
                    body: formData,
                });
    ...
    const quickConversions = [
        { from: "Any", to: "application/vnd.visio", label: "To VSDX" },
    ...
    const needsQuality = targetFormat === "image/jpeg" || targetFormat === "image/webp" || targetFormat === "application/vnd.visio";

    return (
        <ToolLayout
            title="JPG to VSDX Converter"
            description="Convert JPG to VSDX, PNG, PDF, and more instantly. Fast, free, and secure online conversion."
            category="Image Tools"
            keywords={["jpg to vsdx", "jpg converter", "image converter", "pdf converter"]}
            howToSteps={[
                { name: "Upload File", text: "Upload your JPG or other image file" },
                { name: "Select Target", text: "Choose VSDX or other output format" },

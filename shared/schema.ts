...
export const seoSettings = pgTable("seo_settings", {
  ...
  landingMetaTitle: text("landing_meta_title"),
  landingMetaDescription: text("landing_meta_description"),
  landingOgTitle: text("landing_og_title"),
  landingOgDescription: text("landing_og_description"),
  landingKeywords: text("landing_keywords"),
  landingH1: text("landing_h1"),
  landingSubtitle: text("landing_subtitle"),
  landingCanonicalUrl: text("landing_canonical_url"),
  landingIndexStatus: text("landing_index_status").default("index"),
  landingFollowStatus: text("landing_follow_status").default("follow"),
  landingIntroContent: text("landing_intro_content"),
  landingBottomContent: text("landing_bottom_content"),
